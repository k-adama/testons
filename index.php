...
<div class="container mt-3">
  ...
  <ul class="nav">
    ...
    <li class="nav-item">
      <a class="nav-link" href="index.php?page=1">Nos recettes</a>
    </li>
    <li class="nav-item">
      <a class="nav-link" href="index.php?page=2">P2</a>
    </li>
...
if($page == 1){
 ...
 //recettes
  ?>
   <div class="container">
           ...
           <div class="row">
               <div class="col-4">
                  <img src="image/placali.jpg" class="img-thumbnail" alt="" style="width:100%; height:222px">
                  <p>Placli sauce graine</p>
                 
                  <a href="index.php?page=5"> <button type="button" class="btn btn-dark">Voir la recette</button></a>
               </div>
               <div class="col-4">
                  <img src="image/foufou.jpg" class="img-thumbnail" alt="" style="width:100%; height:auto">
                  <p>Foufou</p>
                  <a href="index.php?page=5"> <button type="button" class="btn btn-dark">Voir la recette</button></a>
               </div>
               <div class="col-4">
                  <img src="image/saucefeuille1.jpg" class="img-thumbnail" alt="" style="width:100%; height:auto">
                  <p>Sauce feuille</p>
                  <a href="index.php?page=5"> <button type="button" class="btn btn-dark">Voir la recette</button></a>
               </div>
           </div>
           ...
           <div class="row">
               <div class="col-4">
                  <img src="image/cafebaoule.jpg" class="img-thumbnail" alt="" style="width:100%; height:auto">
                 <p>Café baoulé</p>
                 <a href="index.php?page=5"> <button type="button" class="btn btn-dark">Voir la recette</button></a>
               </div>
               <div class="col-4">
                  <img src="image/pistache1.jpg" class="img-thumbnail" alt="" style="width:100%; height:272px">
                  <p>Sauce pistache</p>
                  <a href="index.php?page=5"> <button type="button" class="btn btn-dark">Voir la recette</button></a>
               </div>
             </div>
 ...
 //recettes
  ?>
  <h1 style='text-align:center; color:red'>SITE EN CONSTRUCTION</h1>
  <img src="image/construction.jpg" class="img-thumbnail" alt="" style="width:100%; height:auto" alt="" >
  <?php
